...
if ( ! function_exists( 'news_blog_social_icons_svg_list' ) ) :    
	/**
	 * Get SVG Image
	*/
	function news_blog_social_icons_svg_list( $social ){
...
if( ! function_exists( 'news_blog_is_woocommerce_activated' ) ) :
	/**
	 * Query WooCommerce activation
	 */
	function news_blog_is_woocommerce_activated() {
		return class_exists( 'woocommerce' ) ? true : false;
	}
endif;

if( ! function_exists( 'news_blog_is_btnw_activated' ) ) :
	/**
	 * Is gradientthemes Email Newsletters active or not
	*/
	function news_blog_is_btnw_activated(){
...
function news_blog_post_grid( $loop, $max_height, $title, $layout, $excerpt, $colums ){
		...
		while( $loop->have_posts() ) : $loop->the_post();
			...
			<div class="<?php echo esc_attr($colums); ?> post-compact" >
		  		<div class="background-img"  style="background-image: url('<?php echo esc_url($image_attributes); ?>');height:<?php echo esc_attr($max_height); ?>px;background-size: cover; background-position: center;" >
                    
                    <a  href="<?php the_permalink(); ?>">
                      <?php
                        $news_blog_thumb_size = 'news-blog-featured';
                        if ($colums =='col-md-12 col-sm-12 col-lg-12 col-xs-12') { $news_blog_thumb_size = 'news-blog-slider-full'; }
                        //if ( has_post_thumbnail() ) {
                            //the_post_thumbnail($news_blog_thumb_size);
                        //} 
                        ?>
                    </a>
                    <?php news_blog_post_type_img($post_id); ?>
                    <div class="post-compact-container" >
                        ...
                        <div class="portfolio-content" >
                            ...
                            <?php news_blog_print_post_cat($post_id); ?>												
                        </div>
			...
			<div class="<?php echo esc_attr($colums); ?> post-grid" >
			 <div class="post-content equal" >
                <?php news_blog_post_type_img($post_id); ?>
		  		<div class="post-compact-container" >
                    <div class="post-img" style="background-image: url('<?php echo esc_url($image_attributes); ?>');height:<?php echo esc_attr($max_height); ?>px;background-size: cover; background-position: center;" >
                      <a  href="<?php the_permalink(); ?>">                    
                      <?php
                        $news_blog_thumb_size = 'news-blog-medium';
                        if ($colums =='col-md-12 col-sm-12 col-lg-12 col-xs-12') { $news_blog_thumb_size = 'news-blog-medium'; }
                        //if ( has_post_thumbnail() ) {
                            //the_post_thumbnail($news_blog_thumb_size);
                        //} else 
                        ?>
					...
					<div class="layout-list portfolio-content" >
						...
						<p><?php echo wp_kses_post( news_blog_trim_content($excerpt , $post) ); ?></p>
						<?php endif; ?>
						
						<a class="more-link" href="<?php the_permalink(); ?>"><?php echo esc_html__("Read More", "news-blog"); ?></a>
					</div>
				</div>				
			</div>
			<?php
			...
			?>
			<div class="<?php echo esc_attr($colums); ?>  post-list equal">
			 <div class="post-content vertical-center " >		  
		  		<div class="<?php if($layout == 4) echo 'small-list'; ?> post-img" style="height:<?php echo esc_attr($max_height); ?>px;overflow:hidden">
					
					<a  href="<?php the_permalink(); ?>">
                      <?php
                        if ( has_post_thumbnail() ) {
                            the_post_thumbnail('news-blog-medium');
                        } else 
                        ?>                        
                    </a>
					<?php news_blog_print_post_cat($post_id); ?>
			...
			<div class="<?php echo esc_attr($colums); ?> post-summery">
			 ...
			 <div class="post-content">		  
		  		<div class="post-img" style="height:<?php echo esc_attr($max_height); ?>px;overflow:hidden">
					<a  href="<?php the_permalink(); ?>">
                      <?php
                        if ( has_post_thumbnail() ) {
                            the_post_thumbnail('news-blog-medium-square');
                        } 
                        ?>
...
function news_blog_post_type_img($post_id){
    
    $post_type = get_post_format($post_id);
    if($post_type=='image'){
        ?><div class="em-post-format"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M5 8.5c0-.828.672-1.5 1.5-1.5s1.5.672 1.5 1.5c0 .829-.672 1.5-1.5 1.5s-1.5-.671-1.5-1.5zm9 .5l-2.519 4-2.481-1.96-4 5.96h14l-5-8zm8-4v14h-20v-14h20zm2-2h-24v18h24v-18z"/></svg></div><?php
    } else if($post_type=='video'){
        ?><div class="em-post-format"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 2c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10zm0-2c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-3 17v-10l9 5.146-9 4.854z"/></svg></div><?php
    } else if($post_type=='audio'){
        ?><div class="em-post-format">
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M3 9v6h-1v-6h1zm13-7l-9 5v2.288l7-3.889v13.202l-7-3.889v2.288l9 5v-20zm6.416 2.768l-4.332 2.5 1 1.732 4.332-2.5-1-1.732zm-17.416 2.232h-5v10h5v-10zm19 4h-5v2h5v-2zm-4.916 4l-1 1.732 4.332 2.5 1-1.732-4.332-2.5z"/></svg>
        ...
        ?><div class="em-post-format"><svg clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m7.73 16.4c0-.53-.47-1-1-1h-3.73c-.53 0-1 .47-1 1v2.6c0 .53.47 1 1 1h3.73c.53 0 1-.47 1-1zm14.27 0c0-.53-.47-1-1-1h-3.73c-.53 0-1 .47-1 1v2.6c0 .53.47 1 1 1h3.73c.53 0 1-.47 1-1zm-7.135-.084c0-.53-.47-1-1-1h-3.73c-.53 0-1 .47-1 1v2.6c0 .531.47 1 1 1h3.73c.53 0 1-.469 1-1zm-11.365.584h2.73v1.6h-2.73zm14.27 0h2.73v1.6h-2.73zm-7.135-.084h2.73v1.6h-2.73zm11.365-11.816c0-.53-.47-1-1-1h-18c-.53 0-1 .47-1 1v8c0 .53.47 1 1 1h18c.53 0 1-.47 1-1zm-18.5.5h17v7h-17z" fill-rule="nonzero"/></svg></div><?php        
    } else {
        echo '';
    }
}
 ...
 * 
 */
function news_blog_print_post_cat ( $post_id ){
...
if ( ! function_exists( 'news_blog_trim_content' ) ) :
	/**
	 ...
	 */
	function news_blog_trim_content( $length = 40, $post_obj = null ) {
		global $post;
		if ( is_null( $post_obj ) ) {
			$post_obj = $post;
		}
	   ...
	   return apply_filters( 'news_blog_trim_content', $trimmed_content );
	}
endif;
...
function news_blog_list_popular_taxonomies($taxonomy, $title, $number = 5)
{
    ...
    if (isset($popular_taxonomies) && !empty($popular_taxonomies)):
        $html .= '<div class="gth-popular-taxonomies-lists clearfix">';
        if (!empty($title)):
            $html .= '<strong>';
            $html .= esc_html($title);
            $html .= '</strong>';
 ...
 * Category functions
 */
function news_blog_get_column_list(){
    return array(
...
function news_blog_get_layout_list(){
    return array(
                '1'=> esc_html__('Compact', 'news-blog'), 
				'2'=> esc_html__('Grid', 'news-blog'), 
				'3'=> esc_html__('List', 'news-blog'),
                '4'=> esc_html__('Small List', 'news-blog'),
				'5'=> esc_html__('Summery', 'news-blog')                            
                );	
}

//global varaiable to display category lists
$news_blog_cat_list ='';

function news_blog_get_category_list() {
    
    global $news_blog_cat_list;
    
    if($news_blog_cat_list !='') return $news_blog_cat_list;
    ...
    foreach ( $categories as $cat ) {
        $choices_list[esc_html($cat->term_id)] = esc_html($cat->name);        
    }
    
    //set global variable
    $news_blog_cat_list = $choices_list;
    
    return $news_blog_cat_list;
