...
class news_blog_header_media_widget extends WP_Widget {
...
function __construct() {
		...
		'news_blog_header_media_widget', 
		  
		// Widget name will appear in UI
		__('+ Header Media Banner', 'news-blog'), 
		  
		// Widget description
		array( 'description' => __( 'Display a banner with Header Media (Image or Video)', 'news-blog' ), ) 
		);    
}
...
public function form( $instance ) {
    ...
    <p>
        <?php echo esc_html__('Display header media as a banner. Change header image or video Go to:- Appearance -> Customize -> Header Media', 'news-blog'); ?>
    </p>

    <p>
    <label for="<?php echo esc_attr($this->get_field_id( 'banner_title' )); ?>"><?php esc_html_e( 'Banner Title:', 'news-blog'  ); ?></label> 
    ...
    <p>
    <label for="<?php echo esc_attr($this->get_field_id( 'banner_content' )); ?>"><?php esc_html_e( 'Banner Content:', 'news-blog'  ); ?></label> 
    ...
    <p>
    <label for="<?php echo esc_attr($this->get_field_id( 'banner_btn_label' )); ?>"><?php esc_html_e( 'Button Label:', 'news-blog'  ); ?></label> 
    ...
    <p>
    <label for="<?php echo esc_attr($this->get_field_id( 'banner_link' )); ?>"><?php esc_html_e( 'Banner Link:', 'news-blog'  ); ?></label> 
    ...
    <p>
    <label for="<?php echo esc_attr($this->get_field_id( 'banner_btn_two_label' )); ?>"><?php esc_html_e( 'Button Two Label:', 'news-blog'  ); ?></label> 
    ...
    <p>
    <label for="<?php echo esc_attr($this->get_field_id( 'banner_btn_two_link' )); ?>"><?php esc_html_e( 'Button Two Link:', 'news-blog'  ); ?></label> 
...
function news_blog_header_media_widget() {
		register_widget( 'news_blog_header_media_widget' );
}
add_action( 'widgets_init', 'news_blog_header_media_widget' );