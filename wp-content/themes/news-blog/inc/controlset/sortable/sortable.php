...
if( ! class_exists( 'news_blog_Pill_Checkbox_Custom_Control' ) ){
    
class news_blog_Pill_Checkbox_Custom_Control extends WP_Customize_Control {
		/**
		...
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', get_template_directory_uri()  . '/inc/controlset/sortable/control.js', array( 'jquery', 'jquery-ui-core' ), '1.1', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', get_template_directory_uri()  . '/inc/controlset/sortable/control.css', array(), '1.0', 'all' );
		}
		/**
